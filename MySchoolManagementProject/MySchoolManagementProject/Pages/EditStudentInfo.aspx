<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditStudentInfo.aspx.cs" Inherits="MySchoolManagementProject.Pages.EditStudentInfo" %>
    ...
    <section id="main-content">
      <section class="wrapper">
        <div style="height:100px; ">
          <a href="AddStudent.aspx" runat="server" style="font-size:15px; text-decoration:underline; font-weight:bold">Back To Add Student</a>
        </div>

        <form runat="server" style="align-items:center; margin: 2px auto auto auto">
        <div style="align-items:center; min-height:400px; width: 85%; margin:inherit; padding-bottom: 5px;">
                     <h3>All Student Information</h3>
            <hr />
            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="StudentID" DataSourceID="SqlDataSource1" ForeColor="Black">
                <Columns>
                    <asp:CommandField ShowDeleteButton="True" ShowEditButton="True" ShowSelectButton="True" />
                    <asp:BoundField DataField="StudentID" HeaderText="StudentID" InsertVisible="False" ReadOnly="True" SortExpression="StudentID" />
                    <asp:BoundField DataField="StuName" HeaderText="StuName" SortExpression="StuName" />
                    <asp:BoundField DataField="StuEmail" HeaderText="StuEmail" SortExpression="StuEmail" />
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" DeleteCommand="DELETE FROM [Student] WHERE [StudentID] = @StudentID" InsertCommand="INSERT INTO [Student] ([StuName], [StuEmail], [RollNo], [FatherName], [MotherName], [Gender], [DateOfBirth], [DateOfAdmission], [ClassID], [Address]) VALUES (@StuName, @StuEmail, @RollNo, @FatherName, @MotherName, @Gender, @DateOfBirth, @DateOfAdmission, @ClassID, @Address)" SelectCommand="SELECT [StudentID], [StuName], [StuEmail], [RollNo], [FatherName], [MotherName], [Gender], [DateOfBirth], [DateOfAdmission], [ClassID], [Address] FROM [Student]" UpdateCommand="UPDATE [Student] SET [StuName] = @StuName, [StuEmail] = @StuEmail, [RollNo] = @RollNo, [FatherName] = @FatherName, [MotherName] = @MotherName, [Gender] = @Gender, [DateOfBirth] = @DateOfBirth, [DateOfAdmission] = @DateOfAdmission, [ClassID] = @ClassID, [Address] = @Address WHERE [StudentID] = @StudentID">
                <DeleteParameters>
